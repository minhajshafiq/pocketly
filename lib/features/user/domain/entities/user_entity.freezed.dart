...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,email,name,avatarUrl,isPremium,premiumExpiresAt,premiumTrialStart,premiumTrialEnd,hasCompletedOnboarding,notificationsEnabled,pushToken,appVersion,marketingConsent,budgetRuleNeeds,budgetRuleWants,budgetRuleSavings,createdAt,updatedAt,role]);

@override
String toString() {
  return 'UserEntity(id: $id, email: $email, name: $name, avatarUrl: $avatarUrl, isPremium: $isPremium, premiumExpiresAt: $premiumExpiresAt, premiumTrialStart: $premiumTrialStart, premiumTrialEnd: $premiumTrialEnd, hasCompletedOnboarding: $hasCompletedOnboarding, notificationsEnabled: $notificationsEnabled, pushToken: $pushToken, appVersion: $appVersion, marketingConsent: $marketingConsent, budgetRuleNeeds: $budgetRuleNeeds, budgetRuleWants: $budgetRuleWants, budgetRuleSavings: $budgetRuleSavings, createdAt: $createdAt, updatedAt: $updatedAt, role: $role)';
}
